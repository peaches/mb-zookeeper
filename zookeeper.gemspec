Gem::Specification.new do |s|
  ...
  s.files = ["README", "lib/zookeeper.rb", "lib/zookeeper/acl.rb", "lib/zookeeper/id.rb", "lib/zookeeper/keeper_exception.rb", "lib/zookeeper/logging.rb", "lib/zookeeper/permission.rb", "lib/zookeeper/stat.rb", "lib/zookeeper/watcher_event.rb", "lib/zookeeper/sync_primitive.rb", "lib/zookeeper/queue.rb"]
  # case RUBY_PLATFORM
  # when /java/
